  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="box">
        ...
        <div class="box-body">
        <form action="/teacher/course/save" method="post" role="form" enctype="multipart/form-data">          
            <div class="col-xs-12">
                <div class="col-xs-4">
                    <table class="table table-hover">
                    <tr><div class="form-group">
                        <label for="">Nama Kursus</label>
                        <input name="course_name" type="text" class="form-control" id="" placeholder="Input field">
                    </div></tr>
                    <tr><div class="form-group">
                ...
                <div class="col-xs-8">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="details" id="input1/(\w+)/\u\1/g" class="form-control" rows="3" ></textarea>
                    </div>
                    </tr>
                    <tr>
                    <div class="form-group">
                        <label>Target Pencapaian</label>
                        <textarea name="vision" id="input1/(\w+)/\u\1/g" class="form-control" rows="3"></textarea>
                    </div>
                    </tr>
                    <tr>
                    <div class="form-group">
                        <label>Persyaratan Materi</label>
                        <textarea name="requirement" id="input1/(\w+)/\u\1/g" class="form-control" rows="3" ></textarea>
                    </div>
                    </tr>
                    <tr><div class="form-group">
