    ...
    <section class="content">
      <div class="box">
        ...
        <div class="box-body">
            <div class="col-xs-12">
                <div class="col-xs-4">
                     <form action="/teacher/user/save" method="post" role="form" enctype="multipart/form-data">          
                    ...
                    <tr> <div class="form-group">
                        ...
                        <input name="phone" type="text" class="form-control" id="" placeholder="" value="<?php echo $details->phone;?>">
                    </div> </tr>
                    <tr> <div class="form-group">
                        <label for="">Pendidikan Terakhir</label>
                        <input name="school" type="text" class="form-control" id="" placeholder="" value="<?php echo $details->school;?>">
                    </div> </tr>
                    <tr><div class="form-group" >
                ...
                <div class="col-xs-8">
                    ...
                    <legend>Change Password</legend>
                      <form class="form-control" method="post" action="/teacher/user/password">
